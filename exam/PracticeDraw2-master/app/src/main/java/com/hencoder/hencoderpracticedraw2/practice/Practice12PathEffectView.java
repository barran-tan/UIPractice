...
public class Practice12PathEffectView extends View {
    ...
    private PathEffect corner, discrete, dash, pathDash, sum, compose;
...

    {
        ...
        discrete = new DiscretePathEffect(30, 5);// 每段长度、偏移
        dash = new DashPathEffect(new float[] { 40, 10 }, 10);// 数组长度必须为偶数，表示画线长度、dash长度，第二个参数是虚线的偏移
        
        Path dashPath = new Path();
        dashPath.lineTo(5, 5);
        dashPath.lineTo(-5, 5);
        dashPath.lineTo(0, 0);
        pathDash = new PathDashPathEffect(dashPath, 20, 10,

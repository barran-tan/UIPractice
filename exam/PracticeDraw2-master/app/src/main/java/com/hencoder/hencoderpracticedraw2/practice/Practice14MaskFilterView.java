...
public class Practice14MaskFilterView extends View {
    ...
    private BlurMaskFilter filterNormal, filterInner, filterOuter, filterSolid;
...

    {
        ...
        filterNormal = new BlurMaskFilter(100, BlurMaskFilter.Blur.NORMAL);
        filterInner = new BlurMaskFilter(100, BlurMaskFilter.Blur.INNER);
        filterOuter = new BlurMaskFilter(100, BlurMaskFilter.Blur.OUTER);
        filterSolid = new BlurMaskFilter(100, BlurMaskFilter.Blur.SOLID);
    }

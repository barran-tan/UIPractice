    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Keyframe frame50 = Keyframe.ofFloat(0.5f, 100);
                // 结束帧：progress 回落到 80
                Keyframe frame100 = Keyframe.ofFloat(1, 80);
                // 使用 PropertyValuesHolder.ofKeyframe() 来把关键帧拼接成一个完整的属性动画方案
                PropertyValuesHolder holders = PropertyValuesHolder.ofKeyframe("progress", frame0, frame50,frame100);

    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // 第一个： scaleX 从 0 到 1
                PropertyValuesHolder scaleXHolder = PropertyValuesHolder.ofFloat("scaleX",
                        0, 1);
                // 第二个： scaleY 从 0 到 1
                PropertyValuesHolder scaleYHolder = PropertyValuesHolder.ofFloat("scaleY",
                        0, 1);
                // 第三个： alpha 从 0 到 1
                ...
                ObjectAnimator.ofPropertyValuesHolder(view, scaleXHolder, scaleYHolder,
                        alphaHolder).start();
            }
        });
    }
